...
//			show(program);  //It may be useful useful to show this here if code generation fails
		...
		@Test
		public void simple_add() throws Exception {
			String prog = "prog";
			String input = prog + " {int a=1; int b=2; print(a+b);}";
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;3;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void if_statement1() throws Exception {
			String prog = "prog";
			String input = prog + "{if(true){print 3;};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;3;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void if_statement2() throws Exception {
			String prog = "prog";
			String input = prog + "{if(false){print 3;};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void if_statement_add() throws Exception {
			String prog = "prog";
			String input = prog + "{if(true){print(3+39);};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;42;leaving main;",PLPRuntimeLog.globalLog.toString());
		}
		 
		
		@Test
		public void if_statement_scope() throws Exception {
			String prog = "prog";
		...
		@Test
		public void dec_strings() throws Exception {
			String prog = "prog";
			String input = prog + "{string s1 = \"abcdef\"; string s2 = \"ghijk\";}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void print_str() throws Exception {
			String prog = "prog";
			String input = prog + "{print(\"abcdef\");}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
		...
		@Test
		public void print_ch() throws Exception {
			String prog = "prog";
			String input = prog + "{char c = 's';print(c);}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;s;leaving main;",PLPRuntimeLog.globalLog.toString());
		}
		
		
		@Test
		public void p61() throws Exception {
			String prog = "prog";
		...
		@Test
		public void p62() throws Exception {
			String prog = "prog";
		...
		@Test
		public void p63() throws Exception {
			String prog = "prog";
		...
		@Test
		public void p64() throws Exception {
			String prog = "prog";
		...
		@Test
		public void printstr11() throws Exception {
			String prog = "prog";
			String input = prog + "{string s1 = \"abc\"; string s2 = \"def\"; print s1;}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;abc;leaving main;",PLPRuntimeLog.globalLog.toString());
		}
		

		@Test
		public void keepstr() throws Exception {
			String prog = "prog";
			String input = prog + "{string x; x = \"abcc\";}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void printthatstr() throws Exception {
			String prog = "prog";
		...
		// 5 tcs failed but only 4 given
		

		
		@Test
		public void testListDeclaration3_nolist() throws Exception {
			String prog = "listdec";
			String input = prog + "{string i=\"cat\";string j=\"dog\";string b=i+j; if(true){ float i=2.0; print i; print j;}; print i; print b;}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
		...
		/*
		@Test
		public void p6discussionboard_uninit() throws Exception {
			String prog = "prog";
			String input = prog + "{int i; print i;}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("Should give error;",PLPRuntimeLog.globalLog.toString());
		}
		*/
		
		@Test
		public void p6discussionboard_unary() throws Exception {
			String prog = "prog";
			String input = prog + "{int x = -5;int y = +x;print(y);}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
		...
		@Test
		public void booleanLit_brackets() throws Exception {
			String prog = "booleanLit";
			String input = prog + "{print(true);} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
		...
		@Test
		public void expression_binary_LT() throws Exception {
			String prog = "expBin";
			String input = prog + "{ print(5<6);} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;true;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void expression_binary_Test1() throws Exception {
			String prog = "expBin";
			String input = prog + "{int a = 3; boolean b = true; if(true){print 3;};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;3;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void tough_prog() throws Exception {
			String prog = "progtough";
			String input = prog + " {int x= 1; int y =7; print x+y;}";
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
		...
		@Test
		public void tough_prog_2() throws Exception {
			String prog = "progtough";
			String input = prog + " {char x = 'a'; print x;}";
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;a;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void tough_prog_3() throws Exception {
			String prog = "progtough";
			String input = prog + " {int x = 2; float b = x + sin(2.0);}";
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void if_statement_true() throws Exception {
			String prog = "IfIntLit";
			String input = prog + "{if(true){print 3;};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
		...
		@Test
		public void if_statement_false() throws Exception {
			String prog = "IfIntLit";
			String input = prog + "{if(false){print 3;};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
		...
		@Test
		public void if_statement_true_add() throws Exception {
			String prog = "IfIntLit";
			String input = prog + "{if(true){print(3+39);};} ";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
		...
		public void test_case2() throws Exception {
			String prog = "prog";
			String input = prog + "{int x; x = 0; while ( x <4 ) {char x; x = 'a'; print x; x = x + 1;}; print x;}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
			show("Log:\n"+PLPRuntimeLog.globalLog);
			assertEquals("entering main;leaving main;",PLPRuntimeLog.globalLog.toString());
		...
		@Test
		public void add_strings() throws Exception {
			String prog = "prog";
			String input = prog + "{string s1 = \"abc\"; string s2 = \"def\"; print s1+s2;}";	
			byte[] bytecode = genCode(input);		
			runCode(prog, bytecode);	
